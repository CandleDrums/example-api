...
public interface ModelNameQueryService extends BaseQueryService<ModelNameVO> {
    ...
    ResponseResult<ModelNameVO> detail(@PathVariable Serializable num);
    ...
    ResponseResult<List<ModelNameVO>> queryAll(@RequestBody ModelNameVO tableName);
    ...
    ResponseResult<PageResult<ModelNameVO>> queryPagingList(@RequestBody @NotNull Page<ModelNameVO> page);
